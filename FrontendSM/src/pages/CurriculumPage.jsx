...
import {
    Phone, Mail, Facebook, Youtube, MapPin, Search, Wallet, FileText, LogIn, Menu, X, ChevronRight, ChevronDown, BookOpen, Clock, FileCheck, CheckCircle
} from 'lucide-react';
                ...
                <div className="section-container" style={{ maxWidth: '1200px' }}>
                    <div style={{ display: 'flex', gap: '60px', alignItems: 'stretch', flexWrap: 'wrap' }}>
                        ...
                        <div style={{ flex: '1', minWidth: '300px' }}>
                            <h2 style={{ fontSize: '2.5rem', fontWeight: '900', color: '#000', marginBottom: '10px' }}>{data.pageTitle}</h2>
