...
import { 
    ...
    Users, MapPin, Heart, Plus, Trash2, Camera, Info, LogOut,
    BookOpen, Shirt, Trophy, Bus, FolderOpen, Calendar, Megaphone, Clock
} from 'lucide-react';
    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#f8fafc' }}>
            ...
            <div className="settings-sidebar">
                ...
                <button className={`settings-nav-item ${activeTab === 'admission' ? 'active' : ''}`} onClick={() => setActiveTab('admission')}><Users size={18} /> Admission CMS</button>
